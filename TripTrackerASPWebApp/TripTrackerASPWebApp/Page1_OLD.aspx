<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Page1_OLD.aspx.cs" Inherits="TripTrackerASPWebApp.Page1" %>
    ...
    <script type="text/javascript">
      ...
      //  function UpdateTeacher(id) {
        ...
        function NextPageClass() {
            console.log("HI")
            //Call another aspx
            window.location = "EntryPage.aspx?teacherid=" + teacherID + "";
            //window.location.href = "SomePage.aspx";
            //window.location.assign("SomePage.aspx");
        }
...
<body id ="service">
	...
	<div class="list-group">
     ...
     <div data-role="main" class="ui-content">
        ...
        <button class="ui-btn" id="btnSubmitClass" value="Track" onclick="NextPageClass()">Track Class</button>
         <button class="ui-btn" id="btnSubmit" value="Track" onclick="NextPage()">Track Student</button>
     </div>
</body>
</html>
